...
public class C16instanceof {
    public static void main(String[] args) {
        ...
        boolean res1 = ani1 instanceof Animal16; // ani1이 가지고 있는 타입이 Animal16인가?? true;
        boolean res2 = ani1 instanceof Dog16; // 개는 개다 -> true
        boolean res3 = ani1 instanceof Cat16; // 개는 고양이다 -> false
